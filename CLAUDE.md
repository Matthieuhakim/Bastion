...
- **`src/routes/index.ts`** — Route aggregator. Each feature gets its own router file, mounted here. Currently mounts: `/health`, `/v1/agents`, `/v1/credentials`, `/v1/policies`, `/v1/proxy`, `/v1/hitl`.
