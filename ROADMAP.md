...
- Express 5 API server with health endpoint
- Prisma schema with Agent model
- Docker Compose (PostgreSQL + Redis)
- TypeScript SDK stub (`packages/sdk-node`)
- Python SDK stub (`packages/sdk-python`)
...
- **9.2 Deep health check + graceful shutdown**
...
- **9.3 CORS lockdown + dashboard serving**
...
- **9.4 Dockerfile + production Docker Compose**
